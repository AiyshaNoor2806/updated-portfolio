  ...
  return (
    <section className={styles.aboutMeSection}>
      ...
      <div className={styles.aboutMeContent}>
        <p>
          Hello, I'm Aiysha Noor, a passionate web developer with expertise in front-end technologies such as HTML, CSS, TypeScript, and React. I have a strong foundation in building responsive and dynamic websites.
        </p>
        <p>
